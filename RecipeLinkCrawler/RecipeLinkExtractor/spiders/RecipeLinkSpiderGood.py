...
class RecipeLinkSpider(scrapy.Spider):
    name = "RecipeLinksGoodFood"

    allowed_domains = ["https://www.bbcgoodfood.com/"]
    handle_httpstatus_list = [404,400]
    recipe_url = "www.bbcgoodfood.com/recipes/"
    start_urls = ["https://www.bbcgoodfood.com/"]
    csv_path = "./DATA/good_food/good_food.csv"
    dir_path = "./DATA/good_food/"
    ...
    def parse(self, response):
        ...
        for link in links:
            ...
            if "https://www.bbcgoodfood.com/recipes/".upper() in new_link.upper() and new_link not in self.visited and new_link not in self.queue:
