...
class RecipeLinkSpider(scrapy.Spider):
    name = "RecipeLinksYuumly"

    allowed_domains = ["https://www.yummly.com/"]
    handle_httpstatus_list = [404,400]
    recipe_url = "www.yummly.com/recipe/"
    start_urls = ["https://www.yummly.com/"]
    csv_path = "./DATA/yummly/yummly_food.csv"
    dir_path = "./DATA/yummly/"
    ...
    def parse(self, response):
        ...
        for link in links:
            ...
            if "https://www.yummly.com/recipe/".upper() in new_link.upper() and new_link not in self.visited and new_link not in self.queue:
