...
class RecipeLinkSpider(scrapy.Spider):
    name = "RecipeLinksItalian"

    allowed_domains = ["https://www.greatitalianchefs.com/"]
    handle_httpstatus_list = [404,400,500]
    recipe_url = "www.greatitalianchefs.com/recipes/"
    start_urls = ["https://www.greatitalianchefs.com/","https://www.greatitalianchefs.com/recipes","https://www.greatitalianchefs.com/collections/italian-sauce-recipes"]
    csv_path = "./DATA/italian/italian_food.csv"
    dir_path = "./DATA/italian/"
    ...
    def parse(self, response):
        ...
        for link in links:
            ...
            if "https://www.greatitalianchefs.com/recipes/".upper() in new_link.upper() and new_link not in self.visited and new_link not in self.queue:
