...
class RecipeLinkSpider(scrapy.Spider):
    name = "RecipeLinksSpoon"

    allowed_domains = ["spoonacular.com/"]
    handle_httpstatus_list = [404,400,500]
    recipe_url = "spoonacular.com/recipes/"
    start_urls = ["https://spoonacular.com/"]
    csv_path = "./DATA/spoon/spoon_food.csv"
    dir_path = "./DATA/spoon/"
    ...
    def parse(self, response):
        ...
        for link in links:
            ...
            if "https://spoonacular.com/recipes/".upper() in new_link.upper() and new_link not in self.visited and new_link not in self.queue:
