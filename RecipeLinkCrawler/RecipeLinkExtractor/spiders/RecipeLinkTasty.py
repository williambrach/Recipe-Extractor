...
class RecipeLinkSpider(scrapy.Spider):
    name = "RecipeLinksTasty"

    allowed_domains = ["https://tasty.co/"]
    handle_httpstatus_list = [404,400]
    recipe_url = "www.tasty.co/recipe/"
    start_urls = ["https://tasty.co/"]
    csv_path = "./DATA/tasty/tasty_food.csv"
    dir_path = "./DATA/tasty/"
    ...
    def parse(self, response):
        ...
        for link in links:
            ...
            if "https://tasty.co/recipe/".upper() in new_link.upper() and new_link not in self.visited and new_link not in self.queue:
