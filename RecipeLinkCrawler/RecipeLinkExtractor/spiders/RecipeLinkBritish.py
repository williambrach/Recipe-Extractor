...
class RecipeLinkSpider(scrapy.Spider):
    name = "RecipeLinksBritish"

    allowed_domains = ["https://www.greatbritishchefs.com/"]
    handle_httpstatus_list = [404,400,500]
    recipe_url = "www.greatbritishchefs.com/recipes/"
    start_urls = ["https://www.greatbritishchefs.com/"]
    csv_path = "./DATA/british/british_food.csv"
    dir_path = "./DATA/british/"
    ...
    def parse(self, response):
        ...
        for link in links:
            ...
            if "https://www.greatbritishchefs.com/recipes/".upper() in new_link.upper() and new_link not in self.visited and new_link not in self.queue:
